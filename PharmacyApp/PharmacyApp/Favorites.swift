...
class Favorites: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        // Uncomment the following line to display an Edit button in the navigation bar for this view controller.
         Favs = Database.sharedDatabase.queryFav(table: Database.sharedDatabase.tablesArray[0])
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("Database: ", Database.sharedDatabase.queryFav(table: Database.sharedDatabase.tablesArray[0]).count)
    }
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == UITableViewCellEditingStyle.delete{
            let factToUnfavorite = Database.sharedDatabase.queryFactID(table: Database.sharedDatabase.tablesArray[0], factToCheck: Favs[indexPath.row])
            Database.sharedDatabase.factID = factToUnfavorite;
